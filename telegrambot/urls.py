...
urlpatterns = [
    ...
    path('get-json-files/', views.get_json_files, name='get_json_files'),
    path('create-object-from-selected-json/', views.create_object_from_selected_json, name='create_object_from_selected_json'),
