...
http://127.0.0.1:8000/analytics/legal-risks/ сделай заново креативную и стильную страницу с визуализацией и анимацией на тему Анализ юридических рисков в Договорах  (на основе фейковых строительных документов) с использованием NLP-анализа договорной документации и AI-агентов для выявления потенциальных правовых рисков
