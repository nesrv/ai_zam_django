...
Ошибка при сохранении: Ошибка: property 'data_dopuska' of 'ProtokolyObucheniya' object has no setter
...
на основе alpinist_instruction.htm создай html шаблон 
 ...
 на основе главный_инженер_инструкт.htm создай html-шаблона  (формат a4), замени реальные данные на:
