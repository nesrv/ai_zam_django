на http://127.0.0.1:8000/telegram/ отправка сообщений в телеграм группы работает, сделай получение сообщений из телеграм-чатов, и  запись их в бд и вывод истории сообщений в соответствующий 
<div class="messages-container" id="messages-{{objekt.id}}">
