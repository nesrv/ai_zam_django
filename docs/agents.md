...
на http://127.0.0.1:8000/sotrudniki/27/ сделай кнопку 
"← Назад к сотрудникам"

придумай протокол "А-Общие вопросы охраны труда" на основе media\instruction_templates\protokol_2025-ОПП-0016.html

увеличь а админке http://127.0.0.1:8000/admin/sotrudniki/sotrudnikishablonyprotokolov/9/change/
поле для ввода Курс

для таблицы sotrudniki_protokolyobucheniya добавь поле № программы (по умолчанию 2025/AA.00-0000),
из таблицы sotrudniki_sotrudnikishablonyprotokolov удали поле nomer_programmy

для sotrudniki_sotrudnikishablonyprotokolov поле курс должно вмещать такой текст:
"Б-Безопасные методы и приемы выполнения работ при воздействии вредных и (или) опасных производственных факторов, источников опасности, идентифицированных в рамках специальной оценки условий труда и оценки профессиональных рисков"





при нажатии на кнопку "🔍 Просмотр " для раздела "🛡️ Инструктажи" инструктаж открывается на этой же странице с помощью http://127.0.0.1:8000/sotrudniki/41/editor/instruktazh аналогично  "📄 Документы" (http://127.0.0.1:8000/sotrudniki/41/editor/)

измени view для http://127.0.0.1:8000/sotrudniki/36/documents/#
для отображения инструктажей из sotrudniki_instruktazhi

 http://127.0.0.1:8000/sotrudniki/ для столбца Управления сделай кнопку 💼

на http://127.0.0.1:8000/sotrudniki/ добавь столбец "Управление" в html-таблицу
при клике открывается страница http://127.0.0.1:8000/sotrudniki/{id}/documents/ для конкретного сотрудника

на http://127.0.0.1:8000/sotrudniki/41/editor/dolzhnostnaya/ убери окно 'HTML Редактор',
оставь окно  "Предварительный просмотр"

переделай таблицу sotrudniki_instruktazhi:
* сотрудник (из таблицы sotrudniki_sotrudnik)
* инструктаж (1-1 к sotrudniki_shablonyinstruktazhej)
* дата проведения
* инструктор (из таблицы sotrudniki_sotrudnik)

на http://127.0.0.1:8000/sotrudniki/40/documents/ для нажатий на кнопки "Просмотр" сделай новую html-страницу - визуальный веб-редактор в котором отобрази соответствующий документ 

для страниц http://127.0.0.1:8000/sotrudniki/39/documents/ добавь хеадер как на главной странице

создай таблицу шаблоны инструктажей
...
сделай связь между sotrudniki_sotrudnik и sotrudniki_instruktazhi (1 ко многим)
при создании сотрудника автоматически создается первичынй инструктаж

http://127.0.0.1:8000/sotrudniki/37/documents/
...
* Курс
 ...
 2025-В.04-0011.htm переделай  для html-шаблона протокола сотрудника (формат a4), замени реальные данные на:
