...
если у объектов пользователя нет чат-бота и чатов отобрази страницу как добавить бота 

на http://127.0.0.1:8000/objects/profile/ для авторизованного пользователя отобрази только его объекты

 организации связанные с авторизо 

C:\W25\AI-ZAM-DJANGO\object\templates\object\add_bot.html

на http://127.0.0.1:8000/ai-agent/ для неавторизованного пользователя отобрази объекты у которых  у которых поле demo=true 

http://127.0.0.1:8000/objects/demo-profile/ в разделе TELEGRAM- и MAX-боты отобрази ботов
...
отобрази объекты связанные с пользователем и его организацией.
...
в таблицу objekt добавь поле demo, по умолчанию false
